var VendorAutoComplete = React.createClass({
  retrieveDataAsync: function (context, url, data, responseCallback) {
    $.ajax({
      ...
      //add a record for the creation of a vendor
  ...
  ajaxAdd : function(itemId, searchText) {
    ...
    var _this = this;
    var url = "/event_vendors?event_id=" + _this.props.associatedObjectId;
    url = url + "&vendor_id=" + itemId;
  ...
  componentDidMount: function() {
    ...
    .autocomplete({
      source: function( request, response ) {
        ...
        _this.retrieveDataAsync(_this, '/vendors/search', data, response);
      },
      minLength: 2,
      delay:300})
    ...
    render: function () {
      return (
     <input type='text' name='vendor' id='vendor_autocomplete' className='TileInput-field' placeholder='+ Vendors Search/Create'/>
