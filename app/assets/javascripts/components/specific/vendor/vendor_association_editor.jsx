var VendorAssociationEditor = React.createClass({
...
/* React methods */
  ...
  render: function () {
    return (<div>
      <div>
      <VendorAutoComplete associatedObjectId={this.props.associatedObjectId} callback={this.refreshData} /> <br/>
      unassociated_vendors:
      <VendorAssociationList items={this.state.unassociatedItems} associated={false} associatedObjectId={this.props.associatedObjectId} onSuccessCallback={this.refreshData} />
      </div>
      <div>
      associated_vendors:
      <VendorAssociationList  items={this.state.associatedItems} associated={true} associatedObjectId={this.props.associatedObjectId} onSuccessCallback={this.refreshData} />
      </div>
      </div>);
  }
});
